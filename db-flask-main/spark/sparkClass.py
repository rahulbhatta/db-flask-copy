...
class rdd_model : 
  ...
  def get_tfidf(self):
    ...
    rdd.saveAsTextFile("hdfs://com.avg.namenode:9000/user/hadoop/output/")
...
model = rdd_model()
model.load_data("hdfs://com.avg.namenode:9000/user/hadoop/meta/", "hdfs://com.avg.namenode:9000/user/hadoop/count/")
model.get_pearson()
#model.get_tfidf()